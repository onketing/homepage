...
**metadata:** `title: "회사소개 | Growth Wave"`
...
- blockquote: `"규정을 모르면 콘텐츠가 아니라 위험을 만듭니다."` — `"김태훈 / 그로스웨이브 대표"`
- 3 stat cards (inline):
  - `"8년"` / `"규정 검토 경력"`
  - `"12개"` / `"전문직 직군"`
  - `"0건"` / `"광고 규정 위반"`
...
- footer (mono): `"Growth Wave / Since 2026"`
...
- btn1: `"마케팅 컨설팅"` → `/contact`
- btn2: `"카카오톡 1:1 문의"` → `https://open.kakao.com/o/growthwave` (external)
- btn3: `"회사소개서 PDF"` → `/growthwave-brochure.pdf` (download)
...
- feature overlay: `"@growthwave"` / `"스튜디오"`
...
**metadata:** `title: "마케팅 컨설팅 | Growth Wave"`, `description: "그로스웨이브에 전문직 마케팅을 문의하세요. 영업일 1일 내 회신드립니다."`
...
**metadata:** `title: "FAQ | Growth Wave"`  
...
**copy:**
- top hairline: `"Growth Wave · Knowledge — 2026"`
...
**metadata:** `title: "광고 규정 가이드 | Growth Wave"`
...
- footer: `"Growth Wave 자체 체크리스트 — 직군별 항목 보강"`
...
**metadata:** `title: "서비스 | Growth Wave"`
...
**metadata:** `title: "전문직 마케팅 | Growth Wave"`
...
**metadata:** `title: "블로그 마케팅 | Growth Wave"`
...
**metadata:** `title: "숏폼 마케팅 | Growth Wave"`
