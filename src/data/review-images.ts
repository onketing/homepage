...
const review = (n: number, w: number, h: number): ReviewImage => ({
	src: `/images/reviews/review-${String(n).padStart(2, "0")}.jpg`,
	w,
	h,
	alt: "온세상이마케팅이다 고객 후기",
});

const chat = (n: number, w: number, h: number): ReviewImage => ({
	src: `/images/reviews/review-${String(n).padStart(2, "0")}.jpg`,
	w,
	h,
