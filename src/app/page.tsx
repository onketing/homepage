...
export const metadata: Metadata = {
	...
	description:
		"온케팅(온세상이마케팅이다)은 변호사·의사·한의사·수의사·노무사·세무사 등 11개 전문직 직군 전용 마케팅 대행사입니다. 처음 맡은 팀이 끝까지 책임집니다. 재계약율 90%+, 광고 규정 위반 0건.",
	keywords: [
		"전문직 마케팅",
		"변호사 마케팅",
		"의사 마케팅",
	...
	mainEntity: [
		{
			...
			acceptedAnswer: {
				"@type": "Answer",
				text: "변호사·의사·한의사·수의사·노무사·세무사 등 11개 전문직 직군 전용 마케팅 대행사입니다. 처음 맡은 팀이 컨설팅·기획·발행·보고를 끝까지 책임집니다. 재계약율 90%+, 광고 규정 위반 0건입니다.",
			},
		},
		{
			"@type": "Question",
